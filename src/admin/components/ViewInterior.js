...
const ViewInteriorProject = () => {
  ...
  const API_URL = 'https://projectassoicate-1.onrender.com/api/interior';
  ...
  const deleteProject = async (projectId) => {
    ...
    try {
      const response = await fetch(`https://projectassoicate-1.onrender.com/api/interior/interiors/${projectId}`, {
        method: 'DELETE',
      });
